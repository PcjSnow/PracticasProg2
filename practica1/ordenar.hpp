// Fichero de interfaz.hpp de un algoritmo de ordenaci�n de vectores de enteros

// Definici�n de predicados utilizados para simplificar las especificaciones
// de las funciones gen�ricas de este fichero:
//
